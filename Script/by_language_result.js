...
// search By local languauge ISO code
// https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes

const apiKey = '2f0a53451e510a7229857c8608717efc';
// const youtubeApiKey = 'AIzaSyC7bWr31DArqVECDyRJbH-g106fKypGKRE'
const youtubeApiKey = 'AIzaSyCQbR6x55TRiq6ygvN4z0w4dRRomeBN1Mk'
...
const apiPath = {
    ...
    searchByLocalLanguage : (query)=> `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_original_language=${query}`
}
...
function fecthAndbuildMovieSection(fecthUrl, categoryName) {
    ...
    return fetch(fecthUrl)
        ...
        .then(res => {
            ...
            const movies = res.results.filter(ele=>{
                return ele.poster_path!=null || ele.backdrop_path!=null;
            })
